// GSO unit tests - math and main

// Qunit tests

// Unit tests for the gso_binary_math.js and gso_op.js

test("GSO_binary_math.available", function() {
	ok( GSO.notice == "Special binary matrix and vector type.", "SSO notice is not here");	
});

test("GSO_binary_math.author", function() {
	ok( GSO.author == "Joseph James Simpson");	
});

test("GSO_binary_math.limit", function() {
	ok( GSO.limit == 1e-5);	
});

// VecBin code

test("GSO_binary_math.VecBin.new_one_0", function() {
	var elements = [1,2,3,4,5];
	var output = GSO.VecBin.new_one(elements);
	var input = GSO.VecBin.new_one(elements);
	deepEqual( output, input, "New vector is invalid");	
});

test("GSO_binary_math.VecBin.new_one_1", function() {
	var elements = [1,2,3,4,5];
	var output = [1,2,3,4,5];
	var input = GSO.VecBin.new_one(elements).elements;
	deepEqual(input, output, "New vector is invalid");	
});

test("GSO_binary_math.VecBin.O", function() {
	var n = 5;
	var output = [0,0,0,0,0];
	var input = GSO.VecBin.O(n).elements;
	deepEqual(input, output, "New zeros vector is invalid");	
});

test("GSO_binary_math.VecBin.l", function() {
	var n = 5;
	var output = [1,1,1,1,1];
	var input = GSO.VecBin.l(n).elements;
...
test("GSO_binary_math.VecBin.view", function() {
	var elements = [1,2,99,2,1];
	var new_vb = GSO.VecBin.new_one(elements);
...
test("GSO_binary_math.VecBin.setElements", function() {
...
test("GSO_binary_math.MatrixBin.e", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
	var ele = output.e(1,3);
	equal( 3, ele, "New matrix element is invalid");	
});

test("GSO_binary_math.MatrixBin.new_one", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.Id", function() {
	var elements = [[1,0,0],
					[0,1,0],
					[0,0,1]]; 
	var output = GSO.MatrixBin.Id(3);
	deepEqual( output.elements, elements, "New id matrix elements are invalid");	
});

test("GSO_binary_math.MatrixBin.O", function() {
	var elements = [[0,0,0],
					[0,0,0],
					[0,0,0]] ;
	var output = GSO.MatrixBin.O(3);
	deepEqual( output.elements, elements, "New zero matrix elements are invalid");	
});

test("GSO_binary_math.MatrixBin.setE", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.row", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.setRow", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
	var new_row = GSO.VecBin.new_one([77, 44, 22]);
...
test("GSO_binary_math.MatrixBin.col", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.setCol", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
	var new_col = GSO.VecBin.new_one([77, 44, 22]);
...
test("GSO_binary_math.MatrixBin.rows", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.colus", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.dup", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.map", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.isSameSizeAs", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.add", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
	var elements_2 = [[2,4,6],
					[8,10,12],
					[14,16,18]];
    var add_m = GSO.MatrixBin.new_one(elements_2);
    var answer = [[3,6,9],
    			  [12,15,18],
    			  [21,24,27]];
...
test("GSO_binary_math.MatrixBin.subtract", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var answer = [[3,6,9],
    			  [12,15,18],
    			  [21,24,27]];
	var output = GSO.MatrixBin.new_one(answer);
	var elements_2 = [[2,4,6],
					[8,10,12],
					[14,16,18]];
    var subtract_m = GSO.MatrixBin.new_one(elements_2);
    var subtract_matrix = output.subtract(subtract_m);
    deepEqual( subtract_matrix.elements, elements, "Invalid subtract function");
	
});

test("GSO_binary_math.MatrixBin.leftMultiply", function() {
	var elements = [[1,2,3],
					[4,5,6],
					[7,8,9]];
	var output = GSO.MatrixBin.new_one(elements);
...
test("GSO_binary_math.MatrixBin.boolMultiply", function() {
	...
	var elements_two = [[0,0,1],
    			  [1,0,0],
    			  [0,1,0]]
	var matrix_one = GSO.MatrixBin.new_one(elements_one);
	var matrix_two = GSO.MatrixBin.new_one(elements_two);
	var answer = [[1,0,0],
				  [0,1,0],
				  [0,0,1]];
...
test("GSO_binary_math.MatrixBin.setElements", function() {
	var elements_one = [[0,1,0],
					[0,0,1],
					[1,0,0]];
	var matrix_one = GSO.MatrixBin.new_one(elements_one);
...
test("GSO_Operations.author", function() {
	ok( GSO_OP.author == "Joseph James Simpson");	
});

test("GSO_OP.WebOps.initZero", function() {
